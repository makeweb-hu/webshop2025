...
$auth_users = array(
    'admin' => '$2y$10$8cr965c4HJz/3qwvc.9T2OnhH4n.15lnDYAU308FGOXo92ERgS8ni',
    'user' => '$2y$10$8cr965c4HJz/3qwvc.9T2OnhH4n.15lnDYAU308FGOXo92ERgS8ni'
);
...
define('MAX_UPLOAD_SIZE', '204800000');
        ...
        <div class="card mb-2 fm-upload-wrapper">
            <div class="card-header">
                <ul class="nav nav-tabs card-header-tabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#urlUploader" class="js-url-upload" data-target="#urlUploader"><i class="fa fa-link"></i> Feltölés URL-ből</a>
                    </li>
                </ul>
            </div>
            <div class="card-body">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> </a></h3></p>
        ...
        <table class="table table-bordered table-hover table-sm bg-white" id="main-table">
            ...
            if (empty($folders) && empty($files)) {
                ...
                <tfoot>
                    <tr><?php if (!FM_READONLY): ?>
                            <td></td><?php endif; ?>
                        <td colspan="<?php echo (!FM_IS_WIN && !$hide_Cols) ? '6' : '4' ?>"><em><?php echo 'Üres mappa' ?></em></td>
                    </tr>
                </tfoot>
                <?php
            } else {
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-9">
            <ul class="list-inline footer-action">
                ...
                <li class="list-inline-item"><input type="submit" class="hidden" name="delete" id="a-delete" value="Delete" onclick="return confirm('Biztos törli?')">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted"></a></div>
        <?php else: ?>
...
function lng($txt) {
    ...
    $tr['en']['Move']           = 'Áthelyezés';                   $tr['en']['Copy']               = 'Másolás';
    $tr['en']['Save']           = 'Mentés';                   $tr['en']['SelectAll']          = 'Mind kijelölése';
    $tr['en']['UnSelectAll']    = 'Összes kijelölés megszüntetése';           $tr['en']['File']               = 'Fájl';
    $tr['en']['Back']           = 'Vissza';                   $tr['en']['Size']               = 'Méret';
    $tr['en']['Perms']          = 'Jogok';                  $tr['en']['Modified']           = 'Módosítva';
    $tr['en']['Owner']          = 'Tulajdonos';                  $tr['en']['Search']             = 'Keresés';
    $tr['en']['NewItem']        = 'Új elem';               $tr['en']['Folder']             = 'Mappa';
    $tr['en']['Delete']         = 'Törlés';                 $tr['en']['Rename']             = 'Átnevezés';
    $tr['en']['CopyTo']         = 'Másolás';                $tr['en']['DirectLink']         = 'Közvetlen link';
    $tr['en']['UploadingFiles'] = 'Fájlfeltöltés';           $tr['en']['ChangePermissions']  = 'Jogosultság megváloztatása';
    $tr['en']['Copying']        = 'Másolás';                $tr['en']['CreateNewItem']      = 'Új elem hozzáadása';
    $tr['en']['Name']           = 'Név';                   $tr['en']['AdvancedEditor']     = 'Összetett szerkesztő';
    $tr['en']['RememberMe']     = 'Remember Me';            $tr['en']['Actions']            = 'Műveletek';
    $tr['en']['Upload']         = 'Feltöltés';                 $tr['en']['Cancel']             = 'Mégse';
    $tr['en']['InvertSelection']= 'Kijelölés invertálása';       $tr['en']['DestinationFolder']  = 'Cél mappa';
    $tr['en']['ItemType']       = 'Elem típus';              $tr['en']['ItemName']           = 'Elem neve';
    $tr['en']['CreateNow']      = 'Létrehozás';             $tr['en']['Download']           = 'Letöltés';
    $tr['en']['Open']           = 'Megnyitás';                   $tr['en']['UnZip']              = 'Kicsomagolása';
    $tr['en']['UnZipToFolder']  = 'Kicsomagolás mappába';        $tr['en']['Edit']               = 'Szerkesztés';
    $tr['en']['NormalEditor']   = 'Normál szerkesztő';          $tr['en']['BackUp']             = 'Back Up';
    $tr['en']['SourceFolder']   = 'Forrás mappa';          $tr['en']['Files']              = 'Fájlok';
    $tr['en']['Move']           = 'Áthelyezés';                   $tr['en']['Change']             = 'Módosítás';
    $tr['en']['Settings']       = 'Settings';               $tr['en']['Language']           = 'Nyelv';
    $tr['en']['MemoryUsed']     = 'Memory used';            $tr['en']['PartitionSize']      = 'Partíció méret';
    $tr['en']['ErrorReporting'] = 'Error Reporting';        $tr['en']['ShowHiddenFiles']    = 'Rejtett féjlok mutatása';
    $tr['en']['Full size'] 		= 'Teljes méret';				$tr['en']['Help'] 				= 'Segítség';
    $tr['en']['Free of'] 		= 'Szabad';				$tr['en']['Preview'] 			= 'Előnézet';
    $tr['en']['Help Documents'] = 'Segítség';			$tr['en']['Report Issue']		= 'Hiba jelentése';
    $tr['en']['Generate'] 		= 'Generálás';				$tr['en']['FullSize']           = 'Teljes méret';
    $tr['en']['FreeOf']         = 'szabad';                $tr['en']['CalculateFolderSize']= 'Mappa méretének kalkulálása';
    $tr['en']['ProcessID']      = 'Folyamat ID';
    $tr['en']['HideColumns']    = 'Tulajdonso/jogok oszlopok elrejtése';
    $tr['en']['Check Latest Version']= 'Utolsó verzió'; $tr['en']['Generate new password hash'] = 'Új jelszó hash';

...
namespace app\components\SzamlazzHU;

use \app\components\SzamlazzHU\document\Document;
use \app\components\SzamlazzHU\document\DeliveryNote;
use \app\components\SzamlazzHU\document\Proforma;
use \app\components\SzamlazzHU\document\receipt\Receipt;
use \app\components\SzamlazzHU\document\receipt\ReverseReceipt;
use \app\components\SzamlazzHU\document\invoice\Invoice;
use \app\components\SzamlazzHU\document\invoice\ReverseInvoice;
use \app\components\SzamlazzHU\document\invoice\CorrectiveInvoice;
use \app\components\SzamlazzHU\document\invoice\FinalInvoice;
use \app\components\SzamlazzHU\document\invoice\PrePaymentInvoice;
use \app\components\SzamlazzHU\response\SzamlaAgentResponse;
use \app\components\SzamlazzHU\header\DocumentHeader;
...
class SzamlaAgent {
     ...
     */
    const CERTIFICATION_PATH = 'storage/szamlazzhu/cert';

    /**
     * PDF dokumentumok útvonala
     */
    const PDF_FILE_SAVE_PATH = 'storage/szamlazzhu/pdf';

    /**
     * XML fájlok útvonala
     */
    const XML_FILE_SAVE_PATH = 'storage/szamlazzhu/xml';

    /**
     * Fájl mellékletek útvonala
     */
    const ATTACHMENTS_SAVE_PATH = 'storage/szamlazzhu/attachments';

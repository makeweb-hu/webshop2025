...
namespace app\components\Stripe\Identity;
 ...
 * @property null|\app\components\Stripe\StripeObject $last_error If present, this property tells you the last error encountered when processing the verification.
 * @property null|string|\app\components\Stripe\Identity\VerificationReport $last_verification_report ID of the most recent VerificationReport. <a href="https://stripe.com/docs/identity/verification-sessions#results">Learn more about accessing detailed verification results.</a>
 ...
 * @property \app\components\Stripe\StripeObject $options
 * @property null|\app\components\Stripe\StripeObject $redaction Redaction status of this VerificationSession. If the VerificationSession is not redacted, this field will be null.
 ...
 * @property null|\app\components\Stripe\StripeObject $verified_outputs The user’s verified data.
 */
class VerificationSession extends \app\components\Stripe\ApiResource
{
     ...
     *
     * @return \app\components\Stripe\Identity\VerificationSession the canceled verification session
     */
     ...
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\Identity\VerificationSession the redacted verification session
     */

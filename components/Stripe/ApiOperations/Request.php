...
trait Request
{
     ...
     *
     * @throws \app\components\Stripe\Exception\InvalidArgumentException if $params exists and is not an array
     */
    protected static function _validateParams($params = null)
    {
        if ($params && !\is_array($params)) {
            ...
            throw new \app\components\Stripe\Exception\InvalidArgumentException($message);
        }
    }
    ...
    {
        $opts = \app\components\Stripe\Util\RequestOptions::parse($options);
        $baseUrl = isset($opts->apiBase) ? $opts->apiBase : static::baseUrl();
        $requestor = new \app\components\Stripe\ApiRequestor($opts->apiKey, $baseUrl);

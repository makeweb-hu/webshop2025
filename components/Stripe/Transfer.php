 ...
 * @property null|string|\app\components\Stripe\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this transfer on your account balance.
 ...
 * @property null|string|\app\components\Stripe\Account $destination ID of the Stripe account the transfer was sent to.
 * @property string|\app\components\Stripe\Charge $destination_payment If the destination is a Stripe account, this will be the ID of the payment that the destination account received for the transfer.
 ...
 * @property \app\components\Stripe\Collection<\app\components\Stripe\TransferReversal> $reversals A list of reversals that have been applied to the transfer.
 ...
 * @property null|string|\app\components\Stripe\Charge $source_transaction ID of the charge or payment that was used to fund the transfer. If null, the transfer was funded from the available balance.
...
class Transfer extends ApiResource
{
     ...
     *
     * @return \app\components\Stripe\Transfer the canceled transfer
     */
     ...
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\Collection<\app\components\Stripe\TransferReversal> the list of transfer reversals
     */
     ...
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\TransferReversal
     */

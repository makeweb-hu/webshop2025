...
namespace app\components\Stripe\Exception;
...
abstract class ApiErrorException extends \Exception implements ExceptionInterface
{
     ...
     * @param null|array|\app\components\Stripe\Util\CaseInsensitiveArray $httpHeaders the HTTP headers array
     ...
     *
     * @return null|\app\components\Stripe\ErrorObject
     */
     ...
     *
     * @param null|\app\components\Stripe\ErrorObject $error
     */
     ...
     *
     * @return null|array|\app\components\Stripe\Util\CaseInsensitiveArray
     */
     ...
     *
     * @param null|array|\app\components\Stripe\Util\CaseInsensitiveArray $httpHeaders
     */
     ...
     *
     * Cf. the `CODE_*` constants on {@see \app\components\Stripe\ErrorObject} for possible
     * values.
     *
     * @return null|string
     */
    ...
    protected function constructErrorObject()
    {
        ...
        return \app\components\Stripe\ErrorObject::constructFrom($this->jsonBody['error']);
    }
}

 ...
 * @property null|(string|\app\components\Stripe\TaxId)[] $account_tax_ids The account tax IDs associated with the invoice. Only editable when the invoice is a draft.
 ...
 * @property \app\components\Stripe\StripeObject $automatic_tax
 ...
 * @property null|string|\app\components\Stripe\Charge $charge ID of the latest charge generated for this invoice, if any.
 ...
 * @property null|\app\components\Stripe\StripeObject[] $custom_fields Custom fields displayed on the invoice.
 * @property null|string|\app\components\Stripe\Customer $customer The ID of the customer who will be billed.
 * @property null|\app\components\Stripe\StripeObject $customer_address The customer's address. Until the invoice is finalized, this field will equal <code>customer.address</code>. Once the invoice is finalized, this field will no longer be updated.
 ...
 * @property null|\app\components\Stripe\StripeObject $customer_shipping The customer's shipping information. Until the invoice is finalized, this field will equal <code>customer.shipping</code>. Once the invoice is finalized, this field will no longer be updated.
 ...
 * @property null|\app\components\Stripe\StripeObject[] $customer_tax_ids The customer's tax IDs. Until the invoice is finalized, this field will contain the same tax IDs as <code>customer.tax_ids</code>. Once the invoice is finalized, this field will no longer be updated.
 * @property null|string|\app\components\Stripe\PaymentMethod $default_payment_method ID of the default payment method for the invoice. It must belong to the customer associated with the invoice. If not set, defaults to the subscription's default payment method, if any, or to the default payment method in the customer's invoice settings.
 * @property null|string|\app\components\Stripe\Account|\app\components\Stripe\AlipayAccount|\app\components\Stripe\BankAccount|\app\components\Stripe\BitcoinReceiver|\app\components\Stripe\Card|\app\components\Stripe\Source $default_source ID of the default payment source for the invoice. It must belong to the customer associated with the invoice and be in a chargeable state. If not set, defaults to the subscription's default source, if any, or to the customer's default source.
 * @property \app\components\Stripe\TaxRate[] $default_tax_rates The tax rates applied to this invoice, if any.
 ...
 * @property null|\app\components\Stripe\Discount $discount Describes the current discount applied to this invoice, if there is one. Not populated if there are multiple discounts.
 * @property null|(string|\app\components\Stripe\Discount)[] $discounts The discounts applied to the invoice. Line item discounts are applied before invoice discounts. Use <code>expand[]=discounts</code> to expand each discount.
 ...
 * @property null|\app\components\Stripe\ErrorObject $last_finalization_error The error encountered during the previous attempt to finalize the invoice. This field is cleared when the invoice is successfully finalized.
 * @property \app\components\Stripe\Collection<\app\components\Stripe\InvoiceLineItem> $lines The individual line items that make up the invoice. <code>lines</code> is sorted as follows: invoice items in reverse chronological order, followed by the subscription, if any.
 ...
 * @property null|string|\app\components\Stripe\PaymentIntent $payment_intent The PaymentIntent associated with this invoice. The PaymentIntent is generated when the invoice is finalized, and can then be used to pay the invoice. Note that voiding an invoice will cancel the PaymentIntent.
 * @property \app\components\Stripe\StripeObject $payment_settings
 ...
 * @property null|string|\app\components\Stripe\Quote $quote The quote this invoice was generated from.
 ...
 * @property \app\components\Stripe\StripeObject $status_transitions
 * @property null|string|\app\components\Stripe\Subscription $subscription The subscription that this invoice was prepared for, if any.
 ...
 * @property null|string|\app\components\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this invoice belongs to.
 * @property \app\components\Stripe\StripeObject $threshold_reason
 * @property int $total Total after discounts and taxes.
 * @property null|\app\components\Stripe\StripeObject[] $total_discount_amounts The aggregate amounts calculated per discount across all line items.
 * @property \app\components\Stripe\StripeObject[] $total_tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class Invoice extends ApiResource
{
     ...
     *
     * @return \app\components\Stripe\Collection<\app\components\Stripe\InvoiceLineItem> the list of lines (InvoiceLineItem)
     */
     ...
     *
     * @return \app\components\Stripe\Invoice the finalized invoice
     */
     ...
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\Invoice the uncollectible invoice
     */
     ...
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\Invoice the paid invoice
     */
     ...
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\Invoice the sent invoice
     */
     ...
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\Invoice the upcoming invoice
     */
     ...
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\Invoice the voided invoice
     */

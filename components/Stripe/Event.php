 ...
 * @property \app\components\Stripe\StripeObject $data
 ...
 * @property null|\app\components\Stripe\StripeObject $request Information on the API request that instigated the event.

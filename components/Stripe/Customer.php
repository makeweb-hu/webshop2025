 ...
 * @property null|\app\components\Stripe\StripeObject $address The customer's address.
 ...
 * @property null|string|\app\components\Stripe\Account|\app\components\Stripe\AlipayAccount|\app\components\Stripe\BankAccount|\app\components\Stripe\BitcoinReceiver|\app\components\Stripe\Card|\app\components\Stripe\Source $default_source <p>ID of the default payment source for the customer.</p><p>If you are using payment methods created via the PaymentMethods API, see the <a href="https://stripe.com/docs/api/customers/object#customer_object-invoice_settings-default_payment_method">invoice_settings.default_payment_method</a> field instead.</p>
 ...
 * @property null|\app\components\Stripe\Discount $discount Describes the current discount active on the customer, if there is one.
 ...
 * @property \app\components\Stripe\StripeObject $invoice_settings
 ...
 * @property null|\app\components\Stripe\StripeObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
 * @property \app\components\Stripe\Collection<\app\components\Stripe\Account|\app\components\Stripe\AlipayAccount|\app\components\Stripe\BankAccount|\app\components\Stripe\BitcoinReceiver|\app\components\Stripe\Card|\app\components\Stripe\Source> $sources The customer's payment sources, if any.
 * @property \app\components\Stripe\Collection<\app\components\Stripe\Subscription> $subscriptions The customer's current subscriptions, if any.
 * @property \app\components\Stripe\StripeObject $tax
 ...
 * @property \app\components\Stripe\Collection<\app\components\Stripe\TaxId> $tax_ids The customer's tax IDs.
 * @property null|string|\app\components\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this customer belongs to.
 */
class Customer extends ApiResource
{
     ...
     *
     * @return \app\components\Stripe\Customer the updated customer
     */
     ...
     *
     * @return \app\components\Stripe\Collection<\app\components\Stripe\Customer> list of PaymentMethods
     */
     ...
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\Collection<\app\components\Stripe\CustomerBalanceTransaction> the list of customer balance transactions
     */
     ...
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\CustomerBalanceTransaction
     */
     ...
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\Collection<\app\components\Stripe\AlipayAccount|\app\components\Stripe\BankAccount|\app\components\Stripe\BitcoinReceiver|\app\components\Stripe\Card|\app\components\Stripe\Source> the list of payment sources (AlipayAccount, BankAccount, BitcoinReceiver, Card or Source)
     */
     ...
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\AlipayAccount|\app\components\Stripe\BankAccount|\app\components\Stripe\BitcoinReceiver|\app\components\Stripe\Card|\app\components\Stripe\Source
     */
     ...
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\Collection<\app\components\Stripe\TaxId> the list of tax ids
     */
     ...
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\TaxId
     */

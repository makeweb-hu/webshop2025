 ...
 * @property \app\components\Stripe\StripeObject $ach_credit_transfer
 * @property \app\components\Stripe\StripeObject $ach_debit
 ...
 * @property \app\components\Stripe\StripeObject $code_verification
 ...
 * @property \app\components\Stripe\StripeObject $multibanco
 * @property null|\app\components\Stripe\StripeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property \app\components\Stripe\StripeObject $p24
 * @property \app\components\Stripe\StripeObject $receiver
 * @property \app\components\Stripe\StripeObject $redirect
 * @property \app\components\Stripe\StripeObject $sepa_credit_transfer
 * @property \app\components\Stripe\StripeObject $sepa_debit
 * @property \app\components\Stripe\StripeObject $sofort
 * @property \app\components\Stripe\StripeObject $source_order
 ...
 * @property \app\components\Stripe\StripeObject $three_d_secure
 ...
 * @property \app\components\Stripe\StripeObject $wechat
 */
class Source extends ApiResource
{
     ...
     *
     * @throws \app\components\Stripe\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\Source the detached source
     */
     ...
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\Collection the list of source transactions
     */
     ...
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\Source the verified source
     */

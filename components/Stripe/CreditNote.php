 ...
 * @property string|\app\components\Stripe\Customer $customer ID of the customer.
 * @property null|string|\app\components\Stripe\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 * @property int $discount_amount The integer amount in %s representing the total amount of discount that was credited.
 * @property \app\components\Stripe\StripeObject[] $discount_amounts The aggregate amounts calculated per discount for all line items.
 * @property string|\app\components\Stripe\Invoice $invoice ID of the invoice.
 * @property \app\components\Stripe\Collection<\app\components\Stripe\CreditNoteLineItem> $lines Line items that make up the credit note
 ...
 * @property null|string|\app\components\Stripe\Refund $refund Refund related to this credit note.
 ...
 * @property \app\components\Stripe\StripeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \app\components\Stripe\CreditNote the previewed credit note
     */
     ...
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\CreditNote the voided credit note
     */
     ...
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\Collection<\app\components\Stripe\CreditNoteLineItem> the list of credit note line items
     */

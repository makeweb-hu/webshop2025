 ...
 * @property null|string|\app\components\Stripe\Account $account The ID of the account that the bank account is associated with.
 ...
 * @property null|string|\app\components\Stripe\Customer $customer The ID of the customer that the bank account is associated with.

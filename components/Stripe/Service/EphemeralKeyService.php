...
class EphemeralKeyService extends \app\components\Stripe\Service\AbstractService
{
    /**
     ...
     *
     * @return \app\components\Stripe\EphemeralKey
     */
    ...
    public function create($params = null, $opts = null)
    {
        if (!$opts || !isset($opts['stripe_version'])) {
            throw new \app\components\Stripe\Exception\InvalidArgumentException('stripe_version must be specified to create an ephemeral key');
        }

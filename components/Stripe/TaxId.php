 ...
 * @property null|string|\app\components\Stripe\Customer $customer ID of the customer.
 ...
 * @property null|\app\components\Stripe\StripeObject $verification Tax ID verification information.
 */

...
namespace app\components\Stripe\HttpClient;

use app\components\Stripe\Exception;
use app\components\Stripe\Stripe;
use app\components\Stripe\Util;
...
class CurlClient implements ClientInterface, StreamingClientInterface
{
    ...
    /** @var \app\components\Stripe\Util\RandomGenerator */
     ...
     * @param null|\app\components\Stripe\Util\RandomGenerator $randomGenerator
     */
     ...
     *   <li>\app\components\Stripe\Util\CaseInsensitiveArray $rheaders The response headers</li>
     ...
     * @param int $errno
     * @param int $rcode
     * @param array|\app\components\Stripe\Util\CaseInsensitiveArray $rheaders
     * @param int $numRetries
     *
     * @return bool
     */

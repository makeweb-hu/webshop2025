 ...
 * @property \app\components\Stripe\StripeObject $address
 * @property null|\app\components\Stripe\StripeObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\app\components\Stripe\StripeObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property \app\components\Stripe\StripeObject $dob
 ...
 * @property null|\app\components\Stripe\StripeObject $future_requirements Information about the upcoming new requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \app\components\Stripe\StripeObject $relationship
 * @property null|\app\components\Stripe\StripeObject $requirements Information about the requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property \app\components\Stripe\StripeObject $verification
 */
class Person extends ApiResource
{
     ...
     *
     * @throws \app\components\Stripe\Exception\BadMethodCallException
     */

 ...
 * @property \app\components\Stripe\StripeObject $supported_bank_account_currencies Currencies that can be accepted in the specific country (for transfers).
 ...
 * @property \app\components\Stripe\StripeObject $verification_fields
 */

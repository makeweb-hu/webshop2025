 ...
 * @property null|string|\app\components\Stripe\Issuing\Card $replaced_by The latest card that replaces this card, if any.
 * @property null|string|\app\components\Stripe\Issuing\Card $replacement_for The card this card replaces, if any.
 * @property null|string $replacement_reason The reason why the previous card needed to be replaced.
 * @property null|\app\components\Stripe\StripeObject $shipping Where and how the card will be shipped.
 * @property \app\components\Stripe\StripeObject $spending_controls
 * @property string $status Whether authorizations can be approved on this card.
 * @property string $type The type of the card.
 * @property null|\app\components\Stripe\StripeObject $wallets Information relating to digital wallets (like Apple Pay and Google Pay).
 */
class Card extends \app\components\Stripe\ApiResource
{
     ...
     *
     * @return \app\components\Stripe\Issuing\CardDetails the card details associated with that issuing card
     */
    public function details($params = null, $opts = null)
    {
        $url = $this->instanceUrl() . '/details';
        list($response, $opts) = $this->_request('get', $url, $params, $opts);
        $obj = \app\components\Stripe\Util\Util::convertToStripeObject($response, $opts);

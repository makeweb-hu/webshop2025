 ...
 * @property null|\app\components\Stripe\StripeObject $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 * @property string|\app\components\Stripe\Customer $customer ID of the customer who owns the subscription schedule.
 * @property \app\components\Stripe\StripeObject $default_settings
 ...
 * @property \app\components\Stripe\StripeObject[] $phases Configuration for the subscription schedule's phases.
 ...
 * @property null|string|\app\components\Stripe\Subscription $subscription ID of the subscription managed by the subscription schedule.
 * @property null|string|\app\components\Stripe\TestHelpers\TestClock $test_clock ID of the test clock this subscription schedule belongs to.
 */
class SubscriptionSchedule extends ApiResource
{
     ...
     *
     * @return \app\components\Stripe\SubscriptionSchedule the canceled subscription schedule
     */
     ...
     * @throws \app\components\Stripe\Exception\ApiErrorException if the request fails
     *
     * @return \app\components\Stripe\SubscriptionSchedule the released subscription schedule
     */

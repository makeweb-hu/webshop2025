 ...
 * @property \app\components\Stripe\Coupon $coupon Hash describing the coupon applied to create this discount.
 * @property string|\app\components\Stripe\Customer $customer The ID of the customer associated with this discount.

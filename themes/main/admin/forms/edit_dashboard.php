<?php
$model = \app\models\Dashboard::findOne($id) ?: new \app\models\Dashboard();

?>

<form data-ajax-form data-action="/admin-api/edit?class=Dashboard&id=<?=$id?>" data-redirect-url="(current)">

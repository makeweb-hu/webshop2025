<?php
$model = \app\models\TulajdonsagOpcio::findOne($id) ?: new \App\Models\TulajdonsagOpcio();

?>

<form data-ajax-form data-action="/admin-api/edit?class=TulajdonsagOpcio&id=<?=$id?>" >

<?php
$model = \app\models\Szallitas::findOne($id) ?: new \App\Models\Szallitas();

?>

<form data-ajax-form data-action="/admin-api/edit?class=Szallitas&id=<?=$id?>" data-redirect-url="(current)">
    ...
    <?=\app\components\Helpers::render('ui/multiselect', [
        'name' => 'payments',
        'label' => 'Fizetési módok',
        'values' => \app\models\Fizetes::allForSelect(),
        'value' => $model->paymentIds(),
    ])?>

<?php
$model = \app\models\Kerdoiv::findOne($id) ?: new \App\Models\Kerdoiv();

?>

<form data-ajax-form data-action="/admin-api/edit?class=Kerdoiv&id=<?=$id?>" data-redirect-url="(current)">
    <?=\app\components\Helpers::render('ui/langs', [

    ])?>

    <?php foreach (['hu','de','en','pl','fr','bg'] as $lang): $name = 'cim_' . $lang; ?>

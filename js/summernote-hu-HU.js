(function($) {
  $.extend($.summernote.lang, {
    'hu-HU': {
      ...
      table: {
        table: 'Táblázat',
        addRowAbove: 'Sor beszúrás felette',
        addRowBelow: 'Sor beszúrás alatta',
        addColLeft: 'Oszlop beszúrás balra',
        addColRight: 'Oszlop beszúrás jobbra',
        delRow: 'Sor törlése',
        delCol: 'Oszlop törlése',
        delTable: 'Táblázat törlése',
      },
      hr: {
